...
x = 8#raw_input("enter x co-ordinate of mean1 ")
y = 8#raw_input("enter y co-ordinate of mean1 ")
...
n1 = 500#raw_input("enter the number of samples of first class ")
X1 = numpy.random.multivariate_normal(mean1,covariance1,int(n1))

x = 11#raw_input("enter x co-ordinate of mean2 ")
y = 11#raw_input("enter y co-ordinate of mean2 ")
mean2 = numpy.array([int(x),int(y)])
x1 = 1#raw_input("enter x1 of the 2-dimensional covariance matrix ")
y1 = 0#raw_input("enter y1 of the 2-dimensional covariance matrix ")
x2 = 0#raw_input("enter x2 of the 2-dimensional covariance matrix ")
y2 = 8#raw_input("enter y2 of the 2-dimensional covariance matrix ")
covariance2 = numpy.array([[int(x1),int(y1)],[int(x2),int(y2)]])
n2 = 600#raw_input("enter the number of samples of second class ")
...
while(int(choice) == 1):
    ...
    logistic.calculateStochasticGradientDescent(5e-2,1e4,int(momentumtype),int(regularization))
    print "Hinge Loss***************************"
    hingeloss = HL(X,y_hl,1e-7)
    hingeloss.calculateStochasticGradientDescent(5e-2,1e4,int(momentumtype),int(regularization))
